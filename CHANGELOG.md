...
- Fixed orphaned MC processes after terminal disconnect on macOS
...
- Added `MONSTER_CODE_SHELL_PREFIX` for wrapping Monster and user-provided shell commands run by Monster Code
