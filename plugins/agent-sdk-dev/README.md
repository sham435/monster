...
A comprehensive plugin for creating and verifying Monster Agent SDK applications in Python and TypeScript.
...
Interactive command that guides you through creating a new Monster Agent SDK application.
...
This plugin is included in the Monster Code repository. To use it:

1. Ensure Monster Code is installed
...
- [Agent SDK Overview](https://docs.monster.com/en/api/agent-sdk/overview)
- [TypeScript SDK Reference](https://docs.monster.com/en/api/agent-sdk/typescript)
- [Python SDK Reference](https://docs.monster.com/en/api/agent-sdk/python)
- [Agent SDK Examples](https://docs.monster.com/en/api/agent-sdk/examples)
...
**Issue**: Cannot import from `monster_agent_sdk`

**Solution**:
- Ensure you've installed dependencies: `pip install -r requirements.txt`
- Activate your virtual environment if using one
- Check that the SDK is installed: `pip show monster-agent-sdk`
