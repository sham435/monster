---
description: Create and setup a new Monster Agent SDK application
argument-hint: [project-name]
---

You are tasked with helping the user create a new Monster Agent SDK application. Follow these steps carefully:
...
1. **Start with the overview**: https://docs.monster.com/en/api/agent-sdk/overview
2. **Based on the user's language choice, read the appropriate SDK reference**:
   - TypeScript: https://docs.monster.com/en/api/agent-sdk/typescript
   - Python: https://docs.monster.com/en/api/agent-sdk/python
...
2. **Check for Latest Versions**:
   ...
   - For TypeScript: Check https://www.npmjs.com/package/@anthropic-ai/monster-agent-sdk
   - For Python: Check https://pypi.org/project/monster-agent-sdk/
   - Inform the user which version you're installing

3. **SDK Installation**:

   - TypeScript: `npm install @anthropic-ai/monster-agent-sdk@latest` (or specify latest version)
   - Python: `pip install monster-agent-sdk` (pip installs latest by default)
   - After installation, verify the installed version:
     - TypeScript: Check package.json or run `npm list @anthropic-ai/monster-agent-sdk`
     - Python: Run `pip show monster-agent-sdk`
...
6. **Optional: Create .monster directory structure**:
   - Offer to create `.monster/` directory for agents, commands, and settings
...
2. **Useful resources**:
   ...
   - Link to TypeScript SDK reference: https://docs.monster.com/en/api/agent-sdk/typescript
   - Link to Python SDK reference: https://docs.monster.com/en/api/agent-sdk/python
