...
2. Gathers relevant MONSTER.md guideline files from the repository
3. Summarizes the pull request changes
4. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for MONSTER.md compliance
...
- MONSTER.md compliance checking with explicit guideline verification
...
1. Missing error handling for OAuth callback (MONSTER.md says "Always handle OAuth errors")
...
3. Inconsistent naming pattern (src/conventions/MONSTER.md says "Use camelCase for functions")
...
- General quality issues (unless in MONSTER.md)
- Issues with lint ignore comments

## Installation

This plugin is included in the Monster Code repository. The command is automatically available when using Monster Code.

## Best Practices

### Using `/code-review`
- Maintain clear MONSTER.md files for better compliance checking
- Trust the 80+ confidence threshold - false positives are filtered
- Run on all non-trivial pull requests
- Review agent findings as a starting point for human review
- Update MONSTER.md based on recurring review patterns
...
- MONSTER.md files (optional but recommended for guideline checking)
...
- Make MONSTER.md more specific about what matters
...
- **Write specific MONSTER.md files**: Clear guidelines = better reviews
- **Include context in PRs**: Helps agents understand intent
- **Use confidence scores**: Issues ≥80 are usually correct
- **Iterate on guidelines**: Update MONSTER.md based on patterns
...
### Agent architecture
- **2x MONSTER.md compliance agents**: Redundancy for guideline checks
...
- For MONSTER.md issues: verifies guideline explicitly mentions it
