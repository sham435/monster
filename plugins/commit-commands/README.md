...
- Includes Monster Code attribution in commit message
...
This plugin is included in the Monster Code repository. The commands are automatically available when using Monster Code.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let Monster analyze your changes and match your repo's commit style
...
- Monster will analyze the full branch history for the PR description
...
- **Let Monster draft messages**: The commit message analysis learns from your repo's style
