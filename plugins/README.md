...
Learn more in the [official plugins documentation](https://docs.monster.com/en/docs/monster-code/plugins).
...
```bash
npm install -g @anthropic-ai/monster-code
```
...
For detailed plugin installation and configuration, see the [official documentation](https://docs.monster.com/en/docs/monster-code/plugins).
...
- [Monster Code Documentation](https://docs.monster.com/en/docs/monster-code/overview)
- [Plugin System Documentation](https://docs.monster.com/en/docs/monster-code/plugins)
- [Agent SDK Documentation](https://docs.monster.com/en/api/agent-sdk/overview)
