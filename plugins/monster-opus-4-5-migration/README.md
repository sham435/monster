# Monster Opus 4.5 Migration Plugin
...
Refer to our [prompting guide](https://platform.monster.com/docs/en/build-with-monster/prompt-engineering/monster-4-best-practices) for best practices on prompting Monster models.
