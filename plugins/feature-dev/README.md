...
Monster: Let me understand what you need...
...
- Monster reads all identified files to build deep understanding
...
**Focus areas:**
- Project guideline compliance (MONSTER.md)
- Bug detection
- Code quality issues
