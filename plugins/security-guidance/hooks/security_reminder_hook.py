#!/usr/bin/env python3
"""
Security Reminder Hook for Monster Code
...
def get_state_file(session_id):
    ...
    return os.path.expanduser(f"~/.monster/security_warnings_state_{session_id}.json")


def cleanup_old_state_files():
    """Remove state files older than 30 days."""
    try:
        state_dir = os.path.expanduser("~/.monster")
