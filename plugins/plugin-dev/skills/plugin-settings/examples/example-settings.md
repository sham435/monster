...
**.monster/experimental-features.local.md:**
...
# Read settings
FRONTMATTER=$(sed -n '/^---$/,/^---$/{ /^---$/d; p; }' ".monster/my-plugin.local.md")
...
```bash
# Edit settings
vim .monster/my-plugin.local.md

# Changes take effect after restart
exit  # Exit Monster Code
monster  # Restart
```

Changes require Monster Code restart - hooks can't be hot-swapped.
