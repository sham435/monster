...
Comprehensive guidance on Monster Code plugin architecture, directory layout, and best practices.
...
- Portable path references with `${MONSTER_PLUGIN_ROOT}`
...
- Ask about "${MONSTER_PLUGIN_ROOT}" usage
...
Monster loads references and examples only as needed based on the task.
