...
**Purpose:** Specify which Monster model executes the command
...
- Monster can invoke programmatically
...
**Best practices:**
- Use sparingly (limits Monster's autonomy)
...
**Invalid model name:**
```yaml
model: gpt4  # ❌ Not a valid Monster model
```
