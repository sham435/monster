...
**Important:** All examples below are written as instructions FOR Monster (agent consumption), not messages TO users. Commands tell Monster what to do, not tell users what will happen.

## Example 1: Code Review Command

**File:** `.monster/commands/review.md`
...
**File:** `.monster/commands/security-review.md`
...
**File:** `.monster/commands/test-file.md`
...
**File:** `.monster/commands/document.md`
...
**File:** `.monster/commands/git-status.md`
...
**File:** `.monster/commands/deploy.md`
...
**File:** `.monster/commands/compare-files.md`
...
**File:** `.monster/commands/quick-fix.md`
...
**File:** `.monster/commands/research.md`
...
**File:** `.monster/commands/explain.md`
