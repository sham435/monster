...
Tests individual hook scripts with sample input before deploying to Monster Code.
...
**Features:**
- Sets up proper environment variables (CLAUDE_PROJECT_DIR, MONSTER_PLUGIN_ROOT)
...
- Path in hooks.json is correct (use `${MONSTER_PLUGIN_ROOT}`)
