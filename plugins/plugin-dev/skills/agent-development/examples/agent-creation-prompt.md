...
Use this template to generate agents using Monster with the agent creation system prompt.
...
Send this to Monster (with the agent-creation-system-prompt loaded):
...
Tell Monster when the agent should activate:
...
- **Comprehensive**: Monster includes edge cases and quality checks
