...
3. Check adherence to project best practices and coding standards from MONSTER.md
...
5. **Best Practices**:
   - Follow project-specific standards from MONSTER.md
...
- Missing context (no MONSTER.md): Apply general best practices
