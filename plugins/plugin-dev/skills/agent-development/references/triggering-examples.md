...
assistant: "[How Monster should respond before triggering]"
<commentary>
[Explanation of why this agent should be triggered in this scenario]
</commentary>
assistant: "[How Monster triggers the agent - usually 'I'll use the [agent-name] agent...']"
</example>
```
...
**Purpose:** Show what Monster says before launching the agent
...
**Purpose:** Show how Monster invokes the agent
