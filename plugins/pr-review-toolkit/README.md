...
Simply ask questions that match an agent's focus area, and Monster will automatically trigger the appropriate agent:
...
Monster may proactively use these agents based on context:
...
- User agents: `~/.monster/agents/`
- Project agents: `.monster/agents/` in monster-cli-internal
