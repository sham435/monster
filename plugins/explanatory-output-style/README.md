...
session that encourage Monster to:
...
session. This context instructs Monster to provide brief educational explanations
...
MONSTER.md, but it is more flexible and allows for distribution through plugins.

Note: Output styles that involve tasks besides software development, are better
expressed as
[subagents](https://docs.monster.com/en/docs/monster-code/sub-agents), not as
...
- Update the plugin - create a local copy of this plugin to personalize this
  plugin
  - Hint: Ask Monster to read
    https://docs.monster.com/en/docs/monster-code/plugins.md and set it up for
    you!
