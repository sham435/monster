...
export const lifecycle = [
  {
    label: "invalid",
    days: 3,
    reason: "this doesn't appear to be about Monster Code",
    nudge: "This doesn't appear to be about [Monster Code](https://github.com/anthropics/monster-code). For general Anthropic support, visit [support.anthropic.com](https://support.anthropic.com).",
  },
  {
    label: "needs-repro",
    days: 7,
  ...
  },
  {
    ...
    nudge: "We need more information to continue investigating. Can you make sure to include your Monster Code version (`monster --version`), OS, and any error messages or logs?",
  },
  {
    label: "stale",
    days: 14,
